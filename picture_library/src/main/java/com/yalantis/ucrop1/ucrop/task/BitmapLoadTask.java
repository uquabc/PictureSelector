package com.yalantis.ucrop1.ucrop.task;
...
public class BitmapLoadTask extends AsyncTask<Void, Void, BitmapLoadTask.BitmapWorkerResult> {
    ...
    private final com.yalantis.ucrop1.ucrop.callback.BitmapLoadCallback mBitmapLoadCallback;

    public static class BitmapWorkerResult {

        Bitmap mBitmapResult;
        com.yalantis.ucrop1.ucrop.model.ExifInfo mExifInfo;
        Exception mBitmapWorkerException;

        public BitmapWorkerResult(@NonNull Bitmap bitmapResult, @NonNull com.yalantis.ucrop1.ucrop.model.ExifInfo exifInfo) {
    ...
    protected BitmapWorkerResult doInBackground(Void... params) {
        ...
        com.yalantis.ucrop1.ucrop.model.ExifInfo exifInfo = new ExifInfo(exifOrientation, exifDegrees, exifTranslation);

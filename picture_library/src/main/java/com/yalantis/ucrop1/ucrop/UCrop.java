...
public class UCrop {
    ...
    /**
     * Get Intent to start {@link com.yalantis.ucrop1.ucrop.UCropActivity}
     *
     * @return Intent for {@link com.yalantis.ucrop1.ucrop.UCropActivity}
     */
    public Intent getIntent(@NonNull Context context) {
        mCropIntent.setClass(context, com.yalantis.ucrop1.ucrop.UCropActivity.class);
        mCropIntent.putExtras(mCropOptionsBundle);
        return mCropIntent;
    }
    ...
    public static class Options {
         ...
         */
        public void setAllowedGestures(@com.yalantis.ucrop1.ucrop.UCropActivity.GestureTypes int tabScale,
                                       @com.yalantis.ucrop1.ucrop.UCropActivity.GestureTypes int tabRotate,

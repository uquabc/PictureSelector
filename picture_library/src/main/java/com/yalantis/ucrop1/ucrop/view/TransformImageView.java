...
import com.yalantis.ucrop1.ucrop.callback.BitmapLoadCallback;
import com.yalantis.ucrop1.ucrop.model.ExifInfo;
import com.yalantis.ucrop1.ucrop.util.BitmapLoadUtils;
import com.yalantis.ucrop1.ucrop.util.FastBitmapDrawable;
...
public class TransformImageView extends AppCompatImageView {
    ...
    private com.yalantis.ucrop1.ucrop.model.ExifInfo mExifInfo;
    ...
    public int getMaxBitmapSize() {
        if (mMaxBitmapSize <= 0) {
            mMaxBitmapSize = com.yalantis.ucrop1.ucrop.util.BitmapLoadUtils.calculateMaxBitmapSize(getContext());
        }
    ...
    public void setImageBitmap(final Bitmap bitmap) {
        setImageDrawable(new com.yalantis.ucrop1.ucrop.util.FastBitmapDrawable(bitmap));
    }
    ...
    public com.yalantis.ucrop1.ucrop.model.ExifInfo getExifInfo() {
        return mExifInfo;
    }
    ...
    public Bitmap getViewBitmap() {
        if (getDrawable() == null || !(getDrawable() instanceof com.yalantis.ucrop1.ucrop.util.FastBitmapDrawable)) {
            return null;
        } else {
    ...
    protected void onImageLaidOut() {
        ...
        mInitialImageCorners = com.yalantis.ucrop1.ucrop.util.RectUtils.getCornersFromRect(initialImageRect);

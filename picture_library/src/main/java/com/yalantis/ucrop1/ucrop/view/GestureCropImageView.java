...
import com.yalantis.ucrop1.ucrop.util.RotationGestureDetector;
...
public class GestureCropImageView extends CropImageView {
    ...
    private com.yalantis.ucrop1.ucrop.util.RotationGestureDetector mRotateDetector;
    ...
    private void setupGestureListeners() {
        ...
        mRotateDetector = new com.yalantis.ucrop1.ucrop.util.RotationGestureDetector(new RotateListener());
    }
    ...
    private class RotateListener extends com.yalantis.ucrop1.ucrop.util.RotationGestureDetector.SimpleOnRotationGestureListener {

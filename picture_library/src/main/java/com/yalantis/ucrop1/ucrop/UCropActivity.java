package com.yalantis.ucrop1.ucrop;
...
import com.yalantis.ucrop1.ucrop.model.AspectRatio;
import com.yalantis.ucrop1.ucrop.util.SelectedStateListDrawable;
import com.yalantis.ucrop1.ucrop.view.CropImageView;
import com.yalantis.ucrop1.ucrop.view.GestureCropImageView;
import com.yalantis.ucrop1.ucrop.view.OverlayView;
import com.yalantis.ucrop1.ucrop.view.TransformImageView;
import com.yalantis.ucrop1.ucrop.view.UCropView;
import com.yalantis.ucrop1.ucrop.callback.BitmapCropCallback;
import com.yalantis.ucrop1.ucrop.view.widget.AspectRatioTextView;
import com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private List<com.yalantis.ucrop1.ucrop.view.widget.AspectRatioTextView> mAspectRatioTextViews = new ArrayList<>();
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        com.yalantis.ucrop1.ucrop.view.widget.AspectRatioTextView aspectRatioTextView;
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            ...
            aspectRatioTextView = ((com.yalantis.ucrop1.ucrop.view.widget.AspectRatioTextView) wrapperAspectRatio.getChildAt(0));
    ...
    private void setupRotateWidget() {
        ...
        ((com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView) findViewById(R.id.rotate_scroll_wheel))
                .setScrollingListener(new com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView.ScrollingListener() {
                    @Override
        ...
        ((com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView) findViewById(R.id.rotate_scroll_wheel)).setMiddleLineColor(mActiveWidgetColor);
    ...
    private void setupScaleWidget() {
        ...
        ((com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView) findViewById(R.id.scale_scroll_wheel))
                .setScrollingListener(new com.yalantis.ucrop1.ucrop.view.widget.HorizontalProgressWheelView.ScrollingListener() {
                    @Override
                    public void onScroll(float delta, float totalDistance) {
                        if (delta > 0) {

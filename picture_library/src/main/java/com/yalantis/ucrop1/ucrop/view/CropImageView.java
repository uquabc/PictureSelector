package com.yalantis.ucrop1.ucrop.view;
...
import com.yalantis.ucrop1.ucrop.callback.BitmapCropCallback;
import com.yalantis.ucrop1.ucrop.callback.CropBoundsChangeListener;
import com.yalantis.ucrop1.ucrop.model.CropParameters;
import com.yalantis.ucrop1.ucrop.model.ImageState;
import com.yalantis.ucrop1.ucrop.task.BitmapCropTask;
import com.yalantis.ucrop1.ucrop.util.CubicEasing;
import com.yalantis.ucrop1.ucrop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    private com.yalantis.ucrop1.ucrop.callback.CropBoundsChangeListener mCropBoundsChangeListener;
     ...
     * Then creates and executes {@link com.yalantis.ucrop1.ucrop.task.BitmapCropTask} with proper parameters.
     */
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
        ...
        final com.yalantis.ucrop1.ucrop.model.ImageState imageState = new ImageState(
                mCropRect, com.yalantis.ucrop1.ucrop.util.RectUtils.trapToRect(mCurrentImageCorners),
                getCurrentScale(), getCurrentAngle());

        final com.yalantis.ucrop1.ucrop.model.CropParameters cropParameters = new CropParameters(
    ...
    @Nullable
    public com.yalantis.ucrop1.ucrop.callback.CropBoundsChangeListener getCropBoundsChangeListener() {
    ...
    public void setImageToWrapCropBounds(boolean animate) {
        if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (willImageWrapCropBoundsAfterTranslate) {
                ...
                final float[] currentImageSides = com.yalantis.ucrop1.ucrop.util.RectUtils.getRectSidesFromCorners(mCurrentImageCorners);
    ...
    private float[] calculateImageIndents() {
        ...
        float[] unrotatedCropBoundsCorners = com.yalantis.ucrop1.ucrop.util.RectUtils.getCornersFromRect(mCropRect);

        mTempMatrix.mapPoints(unrotatedImageCorners);
        mTempMatrix.mapPoints(unrotatedCropBoundsCorners);

        RectF unrotatedImageRect = com.yalantis.ucrop1.ucrop.util.RectUtils.trapToRect(unrotatedImageCorners);
        RectF unrotatedCropRect = com.yalantis.ucrop1.ucrop.util.RectUtils.trapToRect(unrotatedCropBoundsCorners);
    ...
    protected boolean isImageWrapCropBounds(float[] imageCorners) {
        ...
        return com.yalantis.ucrop1.ucrop.util.RectUtils.trapToRect(unrotatedImageCorners).contains(RectUtils.trapToRect(unrotatedCropBoundsCorners));
    }
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        public void run() {
            ...
            float newX = com.yalantis.ucrop1.ucrop.util.CubicEasing.easeOut(currentMs, 0, mCenterDiffX, mDurationMs);
            float newY = com.yalantis.ucrop1.ucrop.util.CubicEasing.easeOut(currentMs, 0, mCenterDiffY, mDurationMs);
            float newScale = com.yalantis.ucrop1.ucrop.util.CubicEasing.easeInOut(currentMs, 0, mDeltaScale, mDurationMs);
